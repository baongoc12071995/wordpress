...
if ( ! class_exists( 'Lesse_Kirki_Field_Color' ) ) {

	/**
	 * Field overrides.
	 */
	class Lesse_Kirki_Field_Color extends Lesse_Kirki_Field {
		...
		protected function set_sanitize_callback() {
			...
			$this->sanitize_callback = array( 'Lesse_Kirki_Sanitize_Values', 'color' );
