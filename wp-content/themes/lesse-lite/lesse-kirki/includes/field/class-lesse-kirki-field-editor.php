...
if ( ! class_exists( 'Lesse_Kirki_Field_Editor' ) ) {

	/**
	 * Field overrides.
	 */
	class Lesse_Kirki_Field_Editor extends Lesse_Kirki_Field {
		...
		public static function add_editor() {
			...
			echo '<div id="lessekirki_editor_pane" class="hide">';
			wp_editor( '', 'lessekirki-editor', array(
