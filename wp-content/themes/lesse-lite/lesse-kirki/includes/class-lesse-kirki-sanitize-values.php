...
if ( ! class_exists( 'Lesse_Kirki_Sanitize_Values' ) ) {

	/**
	 * A simple wrapper class for static methods.
	 */
	class Lesse_Kirki_Sanitize_Values {
		...
		public static function __callStatic( $name, $arguments ) {
			error_log( "Lesse_Kirki_Sanitize_Values::$name does not exist" );
			return $arguments;
		}
		 ...
		 *
		 * Deprecated. Use Lesse_Kirki_Field_Checkbox::sanitize() instead.
		 *
		 * @static
		 * @access public
		 * @see Lesse_Kirki_Field_Checkbox::sanitize()
		 * @param bool|string $value Whether the checkbox is checked.
		 * @return bool Whether the checkbox is checked.
		 */
		public static function checkbox( $value ) {
			return Lesse_Kirki_Field_Checkbox::sanitize( $value );
		}
