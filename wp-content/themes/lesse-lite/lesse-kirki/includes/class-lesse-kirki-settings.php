...
if ( ! class_exists( 'Lesse_Kirki_Settings' ) ) {

	/**
	 * Each setting is a separate instance
	 */
	class Lesse_Kirki_Settings {
		...
		/**
		 * Creates a new Lesse_Kirki_Settings object.
		 * Class constructor.
		 *
		 * @access public
		 ...
		 * Makes sure the lessekirki/setting_types filter is applied
		...
		final private function set_setting_types() {
			...
			// Apply the lessekirki/setting_types filter.
			$this->setting_types = apply_filters( 'lessekirki/setting_types', array(
				'default'  => 'Lesse_Kirki_Settings_Default_Setting',
				'repeater' => 'Lesse_Kirki_Settings_Repeater_Setting',
			) );
