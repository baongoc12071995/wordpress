<?php
/**
 * Handles panels added via the Lesse_Kirki API.
 *
 * @package     Lesse_Kirki
 * @category    Core
...
if ( ! class_exists( 'Lesse_Kirki_Panel' ) ) {

	/**
	 * Each panel is a separate instance of the Lesse_Kirki_Panel object.
	 */
	class Lesse_Kirki_Panel {
		...
		private $panel_types = array(
			'default'  => 'Lesse_Kirki_Panels_Default_Panel',
			'expanded' => 'Lesse_Kirki_Panels_Expanded_Panel',
		);
		...
		public function __construct( $args ) {
			...
			$this->panel_types = apply_filters( 'lessekirki/panel_types', $this->panel_types );
			$this->add_panel( $args );
