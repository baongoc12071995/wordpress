...
if ( ! class_exists( 'Lesse_Kirki_Config' ) ) {

	/**
	 * The Lesse_Kirki_Config object
	 */
	final class Lesse_Kirki_Config {
		...
		/**
		 * Set to true if you want to completely disable any Lesse_Kirki-generated CSS.
		 *
		 * @access protected
		 * @var bool
		 */
		 ...
		 * @access private
		 *
		 * @param string $id     @see Lesse_Kirki_Config::get_instance().
		 * @param array  $args   @see Lesse_Kirki_Config::get_instance().
		 */
		private function __construct( $id = 'global', $args = array() ) {
			...
			// Apply any lessekirki/config global filters.
			$defaults = apply_filters( 'lessekirki/config', $defaults );
