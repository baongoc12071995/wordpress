<?php
/**
 * Handles sections created via the Lesse_Kirki API.
 *
 * @package     Lesse_Kirki
 * @category    Core
...
if ( ! class_exists( 'Lesse_Kirki_Section' ) ) {

	/**
	 * Each section is a separate instrance of the Lesse_Kirki_Section object.
	 */
	class Lesse_Kirki_Section {
		...
		private $section_types = array(
			'default'  => 'Lesse_Kirki_Sections_Default_Section',
			'expanded' => 'Lesse_Kirki_Sections_Expanded_Section',
			'hover'    => 'Lesse_Kirki_Sections_Hover_Section',
		);
		...
		public function __construct( $args ) {
			...
			$this->section_types = apply_filters( 'lessekirki/section_types', $this->section_types );
		...
		public function add_section( $args ) {
			...
			if ( isset( $args['icon'] ) ) {
				...
				Lesse_Kirki_Scripts_Icons::generate_script( $args );
			}
		}
	}
}
