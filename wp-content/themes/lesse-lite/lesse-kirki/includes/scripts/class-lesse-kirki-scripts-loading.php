...
if ( ! class_exists( 'Lesse_Kirki_Scripts_Loading' ) ) {

	/**
	 * Modifies the loading overlay.
	 */
	class Lesse_Kirki_Scripts_Loading {
		...
		public function __construct() {
			...
			// Allow disabling the custom loader using the lessekirki/config filter.
		...
		public function add_loader_to_footer() {
			?>
			<div class="lessekirki-customizer-loading-wrapper">
				<span class="lessekirki-customizer-loading"></span>
			</div>
			<?php
		}
		...
		public function add_loader_styles_to_header() {
			...
			<style>
				...
				.lessekirki-customizer-loading-wrapper {
					width: 100%;
					height: 100%;
					position: fixed;
					top: 0;
					...
					background-image: url("<?php echo esc_url_raw( Lesse_Kirki::$url ); ?>/assets/images/lessekirki-logo.svg");
					background-repeat: no-repeat;
					background-position: center center;
				}
				body.wp-customizer-unloading .lessekirki-customizer-loading-wrapper {
					display: block;
					opacity: 1;
				}
				.lessekirki-customizer-loading-wrapper .lessekirki-customizer-loading {
					position: absolute;
					width: 60px;
					height: 60px;
					top: 50%;
