<?php
/**
 * Color Calculations class for Lesse_Kirki
 * Initially built for the Shoestrap-3 theme and then tweaked for Lesse_Kirki.
 *
 * @package     Lesse_Kirki
 * @category    Core
...
if ( ! class_exists( 'Lesse_Kirki_Color' ) ) {

	/**
	 * Helper class for color manipulation.
	 */
	final class Lesse_Kirki_Color extends ariColor {
