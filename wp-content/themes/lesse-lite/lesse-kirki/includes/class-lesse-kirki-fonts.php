...
if ( ! class_exists( 'Lesse_Kirki_Fonts' ) ) {

	/**
	 * The Lesse_Kirki_Fonts object.
	 */
	final class Lesse_Kirki_Fonts {
		 ...
		 *
		 * @return object Lesse_Kirki_Fonts
		 */
		...
		public static function get_all_fonts() {
			...
			return apply_filters( 'lessekirki/fonts/all', array_merge( $standard_fonts, $google_fonts ) );
		}
		 ...
		 */
		 public static function get_standard_fonts() {
			$i18n = Lesse_Kirki_l10n::get_strings();
			...
			return apply_filters( 'lessekirki/fonts/standard_fonts', $standard_fonts );
		}
		...
		public static function get_backup_fonts() {
			...
			return apply_filters( 'lessekirki/fonts/backup_fonts', $backup_fonts );
		}
		...
		public static function get_google_fonts() {
			...
			if ( null === self::$google_fonts || empty( self::$google_fonts ) ) {
				...
				$fonts = include wp_normalize_path( Lesse_Kirki::$path . '/includes/webfonts.php' );
				...
				self::$google_fonts = apply_filters( 'lessekirki/fonts/google_fonts', $google_fonts );
