...
if ( ! class_exists( 'Lesse_Kirki_Output' ) ) {

	/**
	 * Handles field CSS output.
	 */
	class Lesse_Kirki_Output {

		/**
		 * The Lesse_Kirki configuration used in the field.
		 *
		 * @access protected
		 * @var string
		 */
		...
		protected function process_property_value( $property, $value ) {
			$properties = apply_filters( 'lessekirki/' . $this->config_id . '/output/property-classnames', array(
				'font-family'         => 'Lesse_Kirki_Output_Property_Font_Family',
				'background-image'    => 'Lesse_Kirki_Output_Property_Background_Image',
				'background-position' => 'Lesse_Kirki_Output_Property_Background_Position',
			) );
