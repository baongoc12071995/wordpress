...
if ( ! class_exists( 'Lesse_Kirki_Controls_Dashicons_Control' ) ) {

	/**
	 * Dashicons control (modified radio).
	 */
	class Lesse_Kirki_Controls_Dashicons_Control extends Lesse_Kirki_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'lessekirki-dashicons';
		...
		public function to_json() {
			parent::to_json();
			$this->json['icons'] = Lesse_Kirki_Helper::get_dashicons();
		}
		...
		public function enqueue() {
			wp_enqueue_script( 'lessekirki-dashicons' );
		}
