<?php
/**
 * Customizer Control: lessekirki-generic.
 *
 * @package     Lesse_Kirki
 * @subpackage  Controls
...
if ( ! class_exists( 'Lesse_Kirki_Controls_Generic_Control' ) ) {

	/**
	 * A generic and pretty abstract control.
	 * Allows for great manipulation using the field's "choices" argumnent.
	 */
	class Lesse_Kirki_Controls_Generic_Control extends Lesse_Kirki_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'lessekirki-generic';
		...
		public function enqueue() {
			wp_enqueue_script( 'lessekirki-generic' );
		}
