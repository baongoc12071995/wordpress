<?php
/**
 * Customizer Control: lessekirki-radio.
 *
 * @package     Lesse_Kirki
 * @subpackage  Controls
...
if ( ! class_exists( 'Lesse_Kirki_Controls_Radio_Control' ) ) {

	/**
	 * Radio control
	 */
	class Lesse_Kirki_Controls_Radio_Control extends Lesse_Kirki_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'lessekirki-radio' );
		}
