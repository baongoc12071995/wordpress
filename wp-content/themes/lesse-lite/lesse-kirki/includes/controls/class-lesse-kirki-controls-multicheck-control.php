...
if ( ! class_exists( 'Lesse_Kirki_Controls_MultiCheck_Control' ) ) {

	/**
	 * Adds a multicheck control.
	 */
	class Lesse_Kirki_Controls_MultiCheck_Control extends Lesse_Kirki_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'lessekirki-multicheck';
		...
		public function enqueue() {
			wp_enqueue_script( 'lessekirki-multicheck' );
		}
