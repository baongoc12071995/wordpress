...
if ( ! class_exists( 'Lesse_Kirki_Controls_Sortable_Control' ) ) {

	/**
	 * Sortable control (uses checkboxes).
	 */
	class Lesse_Kirki_Controls_Sortable_Control extends Lesse_Kirki_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'lessekirki-sortable';
		...
		public function enqueue() {
			wp_enqueue_script( 'lessekirki-sortable' );
		}
		...
		protected function content_template() {
			...
			<label class='lessekirki-sortable'>
				...
				<ul class="sortable">
					<# for ( i in data.filteredValues ) { #>
						<# if ( data.filteredValues.hasOwnProperty( i ) ) { #>
							<li class='lessekirki-sortable-item' data-value='{{ data.filteredValues[i] }}'>
					...
					<# for ( i in data.invisibleKeys ) { #>
						<# if ( data.invisibleKeys.hasOwnProperty( i ) ) { #>
							<li class='lessekirki-sortable-item invisible' data-value='{{ data.invisibleKeys[i] }}'>
								<i class='dashicons dashicons-menu'></i>
								<i class="dashicons dashicons-visibility visibility"></i>
