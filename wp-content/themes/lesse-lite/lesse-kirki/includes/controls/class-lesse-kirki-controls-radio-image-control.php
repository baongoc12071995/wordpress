...
if ( ! class_exists( 'Lesse_Kirki_Controls_Radio_Image_Control' ) ) {

	/**
	 * Radio Image control (modified radio).
	 */
	class Lesse_Kirki_Controls_Radio_Image_Control extends Lesse_Kirki_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'lessekirki-radio-image';
		...
		public function enqueue() {
			wp_enqueue_script( 'lessekirki-radio-image' );
		}
