...
if ( ! class_exists( 'Lesse_Kirki_Controls_Palette_Control' ) ) {

	/**
	 * Palette control (modified radio).
	 */
	class Lesse_Kirki_Controls_Palette_Control extends Lesse_Kirki_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'lessekirki-palette';
		...
		public function enqueue() {
			wp_enqueue_script( 'lessekirki-palette' );
		}
