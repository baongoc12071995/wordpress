...
if ( ! class_exists( 'Lesse_Kirki_Controls_Preset_Control' ) ) {

	/**
	 * Preset control (modified select).
	 */
	class Lesse_Kirki_Controls_Preset_Control extends Lesse_Kirki_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'lessekirki-preset' );
		}
