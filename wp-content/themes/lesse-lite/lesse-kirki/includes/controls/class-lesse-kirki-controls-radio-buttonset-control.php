...
if ( ! class_exists( 'Lesse_Kirki_Controls_Radio_Buttonset_Control' ) ) {

	/**
	 * Radio Buttonset control (modified radio)
	 */
	class Lesse_Kirki_Controls_Radio_Buttonset_Control extends Lesse_Kirki_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'lessekirki-radio-buttonset';
		...
		public function enqueue() {
			wp_enqueue_script( 'lessekirki-radio-buttonset' );
		}
