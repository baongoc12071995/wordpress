...
if ( ! class_exists( 'Lesse_Kirki_Controls_Spacing_Control' ) ) {

	/**
	 * Spacing control.
	 * multiple checkboxes with CSS units validation.
	 */
	class Lesse_Kirki_Controls_Spacing_Control extends Lesse_Kirki_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'lessekirki-spacing';
		...
		public function enqueue() {
			wp_enqueue_script( 'lessekirki-spacing' );
		}
