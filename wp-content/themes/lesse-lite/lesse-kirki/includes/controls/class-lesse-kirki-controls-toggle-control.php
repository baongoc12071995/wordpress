...
if ( ! class_exists( 'Lesse_Kirki_Controls_Toggle_Control' ) ) {

	/**
	 * Toggle control (modified checkbox).
	 */
	class Lesse_Kirki_Controls_Toggle_Control extends Lesse_Kirki_Controls_Checkbox_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'lessekirki-toggle' );
		}
