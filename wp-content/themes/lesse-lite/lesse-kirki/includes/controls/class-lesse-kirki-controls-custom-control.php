...
if ( ! class_exists( 'Lesse_Kirki_Controls_Custom_Control' ) ) {

	/**
	 * The "custom" control allows you to add any raw HTML.
	 */
	class Lesse_Kirki_Controls_Custom_Control extends Lesse_Kirki_Customize_Control {
