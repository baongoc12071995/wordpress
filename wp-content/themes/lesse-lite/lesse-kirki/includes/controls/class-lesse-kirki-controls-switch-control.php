...
if ( ! class_exists( 'Lesse_Kirki_Controls_Switch_Control' ) ) {

	/**
	 * Switch control (modified checkbox).
	 */
	class Lesse_Kirki_Controls_Switch_Control extends Lesse_Kirki_Controls_Checkbox_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'lessekirki-switch' );
		}
