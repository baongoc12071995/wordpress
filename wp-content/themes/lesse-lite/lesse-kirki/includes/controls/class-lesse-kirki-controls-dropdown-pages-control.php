...
if ( ! class_exists( 'Lesse_Kirki_Controls_Dropdown_Pages_Control' ) ) {
	 ...
	 */
	class Lesse_Kirki_Controls_Dropdown_Pages_Control extends Lesse_Kirki_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'lessekirki-dropdown-pages';
