...
if ( ! class_exists( 'Lesse_Kirki_Controls_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Lesse_Kirki_Controls_Slider_Control extends Lesse_Kirki_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'lessekirki-slider' );
		}
		...
		protected function content_template() {
			...
			<label>
				...
				<div class="wrapper">
					...
					<div class="lessekirki_range_value">
						<span class="value">{{ data.value }}</span>
						<# if ( data.choices['suffix'] ) { #>
							{{ data.choices['suffix'] }}
						<# } #>
					</div>
					<div class="lessekirki-slider-reset">
