wp.customize.controlConstructor['lessekirki-multicolor'] = wp.customize.Control.extend({
	...
	ready: function() {
		...
		function lessekirkiMulticolorChangeHandler( control, value, subSetting ) {
		...
		while ( i < Object.keys( colors ).length ) {
			...
			lessekirkiMulticolorChangeHandler( this, value, keys[ i ] );
