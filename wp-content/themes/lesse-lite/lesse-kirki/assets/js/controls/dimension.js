wp.customize.controlConstructor['lessekirki-dimension'] = wp.customize.Control.extend({
	...
	ready: function() {
		...
		if ( false === lessekirkiValidateCSSValue( control.setting._value ) ) {
		...
		this.container.on( 'change keyup paste', 'input', function() {
			...
			if ( false === lessekirkiValidateCSSValue( value ) ) {
